...
export const workExperiences = [
  ...
  {
    id: 3,
    name: 'Internship at Lyst Technologies',
    pos: 'Software Developer Intern',
    duration: 'Jul-Oct 2025',
    title: [
      '- Develop pages and logic for multiple clients consisting of investment companies and banks using their custom Omni-Chanel Platform system.',
      '- Learned the business logic behind many fin-tech related topics like transactions and deals.',
      '- Gained hands-on experience in fin-tech related web development, bridging front-end and business logic.',
    ],
